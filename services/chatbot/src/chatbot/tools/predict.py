...
def postprocess_predictions(prediction: np.ndarray) -> dict:
    """
...
async def classify(client: httpx.AsyncClient, img_b64: str):
    ...
    try:
        ...
        logger.info('Received inference response from KServe.')
