...
#     --version 1.0 \
#     --model-file helpers/model_definition.py \
#     --serialized-file models/bird_classification/best.pth \
#     --handler helpers/model_process_handler.py \
#     --force
...
gcloud storage cp models/bird_classification/config/ "gs://${MODEL_BUCKET_NAME}/v1/" --recursive
gcloud storage cp models/bird_classification/model-store/ "gs://${MODEL_BUCKET_NAME}/v1/" --recursive